...
<main>
    ...
    <div class="banner">
      ...
      <div class="container">
        <div class="about" style="display: grid; grid-template-columns: repeat(2, 1fr); margin-left: -100px;">
            
            <div class="grid">
                <img src="../customer_assets/images/about.svg" alt="Campus-Wide Merchandise Sales" class="banner-img">
            </div>
            <div class="grid" style="margin-left: -70px;">

                <p class="banner-subtitle" style="font-size: 20px; font-weight: 600; margin-top: 20px;margin-bottom: -0.25rem; color: #061E39">About the Platform</p>

                <h2 class="title">A Centralized Ecommerce Platform for  Bicol University UBO’s, CBO’s, and DBO’s Merchandise</h2>

                <p class="subtitle" style="font-size: 15px; font-weight: 500; letter-spacing: 0.5px;">eBUy is an e-commerce platform established by four people, with the aim of bridging income generating projects in the form of merchandise selling of every organization in Bicol University, into a centralized avenue for e-commerce, for the students. </p><span></span>
                <p class="subtitle" style="font-size: 15px; font-weight: 400; letter-spacing: 0.5px;">At eBUy, our vision is to change how merchandise is accessed and bought within the main campus of Bicol University besides achieving an all-inclusive efficient environment by introducing student organizations into a centralized marketplace. </p><span></span>
                <p class="subtitle" style="font-size: 15px; font-weight: 400; letter-spacing: 0.5px;">With eBUy, student organizations are taking a leap from traditional ways of marketing to reach a wider and more inclusive audience. Student customers can conveniently access arrays of merchandise that might pique their interest.</p>
            </div>
        </div>
    ...
    <div class="banner">
      ...
      <div class="container">
        <h2 class="title-2">Founders</h2>
        
        <div class="founders" style="display: grid; grid-template-columns: repeat(4, 1fr); margin-left:80px; margin-top: 30px;">
            <div class="inner-grid">
                <div class="grid">
                    <img src="../customer_assets/images/Cristina.svg" alt="Campus-Wide Merchandise Sales" class="banner-img">
                </div>
                <div class="grid">
                    <p class="subtitle-1">Ma. Cristina Alianza</p>
                    <p class="subtitle-2">Database Manager</p>
                </div>
            </div>
            <div class="inner-grid">
                <div class="grid">
                    <img src="../customer_assets/images/Rona.svg" alt="Campus-Wide Merchandise Sales" class="banner-img">
                </div>
                <div class="grid">
                    <p class="subtitle-1">Rona May Balangat</p>
                    <p class="subtitle-2">Back-end Developer</p>
                </div>
            </div>
            <div class="inner-grid">
                <div class="grid">
                    <img src="../customer_assets/images/Nherlhin.svg" alt="Campus-Wide Merchandise Sales" class="banner-img">
                </div>
                <div class="grid">
                    <p class="subtitle-1">Nherlhin Guevarra</p>
                    <p class="subtitle-2">UI/UX Developer</p>
                </div>
            </div>
            <div class="inner-grid">
                <div class="grid">
                    <img src="../customer_assets/images/Angela.svg" alt="Campus-Wide Merchandise Sales" class="banner-img">
                </div>
                <div class="grid">
                    <p class="subtitle-1">Angela Anne Therese Hugo</p>
                    <p class="subtitle-2">System Analyst</p>
                </div>
            </div>
