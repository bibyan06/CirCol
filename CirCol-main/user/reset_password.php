...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form action="user_pass_reset.php" method="POST">
            <div class="form-group has-feedback">
                <input type="password" class="input-form" name="password" placeholder="Create new password" required>
            </div>
            <div class="form-group has-feedback">
                <input type="password" class="input-form" name="confirm_password" placeholder="Confirm your password" required>
            </div>
            <div class="row">
                <div class="col-xs-4">
                    <button type="submit" class="btn btn-primary send-btn" name="reset"><i class="fa fa-mail-forward"></i> Reset Password</button>
                </div>
            </div>
        </form>
        <div class="option_btn">
            <a href="login.php" class="Iremember"><ion-icon name="log-in-outline"></ion-icon>Back to Login</a>
            <a href="index.php" class="home"><ion-icon name="home-outline"></ion-icon> Home</a>
        </div>
    </div>
</div>
